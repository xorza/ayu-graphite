...
def palette_from_zed(zed_theme: dict) -> Palette:
    ...
    return Palette(
        ...
        # Tokens below this line have no semantic upstream-Zed equivalent under
        # the contrast pipeline; the values are seeded as hand-tuned constants
        # and survive across reseeds (edit them in the TOML, not here).
        elem_disabled="#353b4b",
        ...
        diagnostic_muted_bg="#4c515a",
        created=s("created"),
        created_bg=s("created.background"),
        deleted=s("deleted"),
        deleted_bg=s("deleted.background"),
        diff_term_plus="#b5ff10",
        diff_term_minus="#ff3b48",
        line_number="#717177",
        line_number_active="#f5f7ff",
        line_number_hover="#c8c8cc",
        scrollbar_thumb="#a4a4a4",
        drop_target="#a7a7a5",
        search_highlight="#7ddeff",
        search_match_active="#ff7d2d",
        ansi_blue=s("terminal.ansi.blue"),
        ansi_magenta=s("terminal.ansi.magenta"),
        ansi_cyan=s("terminal.ansi.cyan"),
        ansi_bright_black="#70747a",
        ansi_dim_black="#404040",
        ansi_bright_red="#8a302b",
        ansi_dim_red="#b05043",
        ansi_bright_green="#75a228",
        ansi_dim_green="#97be42",
        ansi_bright_yellow="#9d7222",
        ansi_dim_yellow="#ba913b",
        ansi_bright_blue="#1e6d96",
        ansi_dim_blue="#3b91ba",
        ansi_bright_magenta="#177083",
        ansi_dim_magenta="#2b94aa",
        ansi_bright_cyan="#3f846e",
        ansi_dim_cyan="#69b9a0",
        ansi_bright_white="#ffffff",
        ansi_dim_white="#9e9d94",
        player_bg_1="#868686",
        player_bg_2="#7c7c7c",
        player_bg_3="#808080",
        player_bg_4="#a4a4a4",
...
def write_palette_toml(path: str, p: Palette) -> None:
    ...
    sections = [
        ...
        ("accent_status", ["accent", "success", "warning", "error", "hint"]),
        (
            "status_bg",
            [
                "info_bg",
        ...
        ("diff", ["created", "created_bg", "deleted", "deleted_bg",
                  "diff_term_plus", "diff_term_minus"]),
        ("chrome", ["line_number", "line_number_active", "line_number_hover",
                    "scrollbar_thumb", "drop_target",
                    "search_highlight", "search_match_active"]),
        ("ansi", ["ansi_blue", "ansi_magenta", "ansi_cyan",
                  "ansi_bright_black", "ansi_dim_black",
                  "ansi_bright_red", "ansi_dim_red",
                  "ansi_bright_green", "ansi_dim_green",
                  "ansi_bright_yellow", "ansi_dim_yellow",
                  "ansi_bright_blue", "ansi_dim_blue",
                  "ansi_bright_magenta", "ansi_dim_magenta",
                  "ansi_bright_cyan", "ansi_dim_cyan",
                  "ansi_bright_white", "ansi_dim_white"]),
        ("players", [f"player_bg_{i}" for i in range(1, 9)]),
        (
            "syntax",
            [
                "syn_keyword",
